...
layout: default
title: "Europa"
permalink: /travel/europa/
---
<div class="wrap">
  <header class="country-header">
    <h1 class="country-title">Europa</h1>
  </header>
  ...
  <a class="continent-card" href="{{ "/travel/europa/toskana/" | relative_url }}">
    <img loading="lazy" src="{{ "/assets/img/ifa1a911e909d0bdc.jpg" | relative_url }}" alt="Toskana">
  ...
  <a class="continent-card" href="{{ "/travel/europa/island/" | relative_url }}">
    <img loading="lazy" src="{{ "/assets/img/ib55e52f26ff694b4.jpg" | relative_url }}" alt="Island">
